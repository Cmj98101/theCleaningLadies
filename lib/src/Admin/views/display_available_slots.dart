...
import 'package:the_cleaning_ladies/src/admin/views/expansionServiceTile.dart';
...
class _DisplayAvailableTimesWidgetState
  ...
  Widget build(BuildContext context) {
    appointmentsToConfirm =
        List<TimeTile>(widget.admin.scheduleSettings.servicesPerGroup);
            ...
            children: [
              Flexible(
                child: Container(
                  ...
                  child: RaisedButton(
                    onPressed: () => addSlot(availableTimes),
                    child: Text(
                      'Add Slot',
              ...
              Flexible(
                child: Container(
                  width: SizeConfig.safeBlockHorizontal * 34,
                  child: RaisedButton(
                    onPressed: () async => addCustomTimeSlot(availableTimes),
                    child: Container(
                      child: Text(
                        'Add Custom Slot',
                        textAlign: TextAlign.center,
