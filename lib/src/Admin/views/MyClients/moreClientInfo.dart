...
import 'package:the_cleaning_ladies/src/Admin/views/MyClients/clientReminderMsgEditor.dart';
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          title: 'Are your Sure?',
                                          content:
                                              '${client.active ? 'You will be changing the this customer to not active!' : 'You will be making this customer active!'}',
                                          useIcon: false,
                                          child: Text(
                      ...
                      child: Column(
                        children: <Widget>[
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: widget.client.showPaymentType,
                                ),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Frequency: ${client.showServiceFrequencyText}',
                              style: TextStyle(
                                fontSize: 16,
                              ),
                            ),
                          ...
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Likes ${client.showServiceTimePreferenceText}',
                              style: TextStyle(
                                fontSize: 16,
                              ),
                            ),
                          ...
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Last Service: ${DateFormat('MM/dd/yy').format(client.lastService)}',
                              style: TextStyle(
                                fontSize: 16,
                              ),
                            ),
                          ...
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Next Service: ${client.nextCleaning} lands on ${client.nextCleaningWeekDay}',
                              style: TextStyle(
                                fontSize: 16,
                              ),
                            ),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: StreamBuilder(
                stream: widget.client.service.history,
            ...
            Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                ...
                StreamBuilder<List<HistoryEvent>>(
                    stream: widget.client.service.profits,
